...
os.environ['CUDA_VISIBLE_DEVICES']="0,1,2"      # 令模型可见的gpu只有那几块


def main():
    setproctitle.setproctitle("Training Object Spatial-Temporal Relationship Graph totally ")
    ...
    args.data_dir = os.path.expanduser('/data/huxiaobo/Data/AI2Thor_offline_data_2.0.2/')
    ...
    if args.test_after_train:
        ...
        # args.load_model ='./work_dirs/a3c_22cls_vistrans_base_train_2021-06-11_10-41-58/trained_models/a3c_22cls_vistrans_base_69796442_5700000_2021-06-11_10-41-58.dat'
        ...
        #full eval
        # work_dir='./work_dirs/a3c_22cls_vistrans_base_train_2021-06-11_10-41-58/'
        # args.work_dir='./work_dirs/a3c_22cls_vistrans_base_train_2021-06-11_10-41-58/'
        # args.save_model_dir = os.path.join(work_dir, 'trained_models')
